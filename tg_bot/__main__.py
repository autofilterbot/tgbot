        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Admin", url="https://t.me/SULTHANBOY10")],
                     [InlineKeyboardButton(text="Movie Group", url="https://t.me/srsuggestionsofficial"), InlineKeyboardButton(text="Group", url="https://t.me/srsuggestionsofficial")],
                     [InlineKeyboardButton(text="🎬 Movie channel", url="https://t.me/srsuggestionsmc"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
